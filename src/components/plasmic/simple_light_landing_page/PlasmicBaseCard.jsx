...
import sty from "./PlasmicBaseCard.module.css"; // plasmic-import: kiI0xDE2vkhN5H/css
...
function PlasmicBaseCard__RenderFunc(props) {
  ...
  return (
    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox___5Pvln, {
          [sty.freeBoxlong___5PvlnFYlb2]: hasVariant(variants, "long", "long")
        })}
      >
        {p.renderPlasmicSlot({
          defaultContents:
      ...
      {(hasVariant(variants, "long", "long") ? true : true) ? (
        <div
          className={classNames(projectcss.all, sty.freeBox__sDwo6, {
            [sty.freeBoxlong__sDwo6FYlb2]: hasVariant(variants, "long", "long")
          })}
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__veFd7)}
                role={"img"}
              />
            ),

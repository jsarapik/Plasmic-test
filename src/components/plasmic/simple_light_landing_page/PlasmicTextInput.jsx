...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: cm2EE3IJeXeZJo/css
import SearchsvgIcon from "./icons/PlasmicIcon__Searchsvg"; // plasmic-import: 6o_9QeUTK4dkDS/icon
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: 2MOz5hvjtvOoTF/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <SearchsvgIcon
                className={classNames(projectcss.all, sty.svg__cmYPx)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__aDw74)}
                role={"img"}
              />
            ),

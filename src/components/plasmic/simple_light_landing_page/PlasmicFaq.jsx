...
import sty from "./PlasmicFaq.module.css"; // plasmic-import: bz2GLGTPQUDwNx/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__zKbs0)}
      >
        <div className={classNames(projectcss.all, sty.freeBox__vbZfQ)}>
          <div className={classNames(projectcss.all, sty.freeBox__s1Iy2)}>
            {p.renderPlasmicSlot({

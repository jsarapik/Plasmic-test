...
import sty from "./PlasmicHomeCta.module.css"; // plasmic-import: ofOgEvtbZPVXb/css
import SphereIcon from "./icons/PlasmicIcon__Sphere"; // plasmic-import: aQdsUzOZQ5-lV3/icon
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__cPgMs)}
      >
        <div
          className={classNames(
            projectcss.all,
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__sETtA)}
        >
          <TextInput
      ...
      {(hasVariant(globalVariants, "screen", "mobile") ? true : true) ? (
        <div className={classNames(projectcss.all, sty.freeBox__fFt8M)}>
          <SphereIcon
